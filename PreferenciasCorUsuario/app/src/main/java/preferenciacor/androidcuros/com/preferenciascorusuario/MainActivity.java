package preferenciacor.androidcuros.com.preferenciascorusuario;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.contains("corEscolhida")){
            String corRecuperado = sharedPreferences.getString("corEscolhida", "Laranja");
            setBackground(corRecuperado);
